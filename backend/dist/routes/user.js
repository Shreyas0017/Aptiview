...
router.post('/apply-template-to-jobs', requireClerkAuth_1.requireClerkAuth, async (req, res) => {
    try {
        const userId = req.clerkUserId;
            ...
            for (const jobId of jobIds) {
                await tx.job.update({
                    ...
                    data: {
                        ...
                        customInterviewContext: customization.context || null,
                        customQuestionsList: customization.questions || [],
                        scoringWeights: customization.scoring ? JSON.stringify(customization.scoring) : undefined,
                        interviewDuration: customization.duration || 20,
                        difficultyLevel: customization.difficulty || 'intermediate'
                    }
                });
            }
        });
